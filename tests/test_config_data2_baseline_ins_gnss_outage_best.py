...
def test_data2_pure_ins_gnss_outage_best_config_keeps_validated_noise_and_contract():
    cfg = load_yaml(REPO_ROOT / "config_data2_baseline_ins_gnss_outage_best.yaml")
    fusion = cfg["fusion"]
    noise = fusion["noise"]
