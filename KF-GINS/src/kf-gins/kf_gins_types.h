...
typedef struct GINSOptions {
    ...
    std::string gnss_update_debug_path = "";
    std::string predict_debug_path = "";
    ...
    void print_options() {
        ...
        if (!gnss_update_debug_path.empty()) {
            std::cout << " - GNSS update debug: " << gnss_update_debug_path << std::endl << std::endl;
        }
        if (!predict_debug_path.empty()) {
            std::cout << " - Predict debug: " << predict_debug_path
                      << " [window " << predict_debug_start_time << ", "
                      << predict_debug_end_time << ")" << std::endl << std::endl;
        }
    }
