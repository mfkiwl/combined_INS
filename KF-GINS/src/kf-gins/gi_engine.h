...
private:
    ...
    void writeGnssUpdateDebugRow();
    void writePredictDebugRow(const std::string &tag,
                              const IMU &imupre,
                              const IMU &imucur,
...
private:
    struct GnssUpdateDebugRecord {
        bool valid = false;
        size_t update_index = 0;
        double gnss_t = 0.0;
        double state_t = 0.0;
        Eigen::Vector3d innovation = Eigen::Vector3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix<double, 21, 1> dx = Eigen::Matrix<double, 21, 1>::Zero();
        Eigen::Vector3d prior_std_ba = Eigen::Vector3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_pos = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_vel = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_att = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_pos_vel = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_pos_att = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_vel_att = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_ba_pos = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d prior_cov_ba_att = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d r_mat = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d s_mat = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d h_att = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d k_pos = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d k_vel = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d k_att = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        Eigen::Matrix3d k_ba = Eigen::Matrix3d::Constant(std::numeric_limits<double>::quiet_NaN());
        PVA pva_before;
        ImuError imuerror_before;
    };

    struct PredictDebugRecord {
        bool valid = false;
        double t_prev = 0.0;
        double t_curr = 0.0;
        double dt = 0.0;
        Eigen::Matrix<double, 21, 21> p_before_common = Eigen::Matrix<double, 21, 21>::Zero();
        Eigen::Matrix<double, 21, 21> phi_common = Eigen::Matrix<double, 21, 21>::Zero();
        Eigen::Matrix<double, 21, 21> qd_common = Eigen::Matrix<double, 21, 21>::Zero();
        Eigen::Matrix<double, 21, 21> phi_p_common = Eigen::Matrix<double, 21, 21>::Zero();
        Eigen::Matrix<double, 21, 21> p_after_common = Eigen::Matrix<double, 21, 21>::Zero();
    };
    ...
    Eigen::MatrixXd Qc_;
    Eigen::MatrixXd dx_;
    std::ofstream gnss_update_debug_file_;
    std::ofstream predict_debug_file_;
    size_t gnss_update_debug_count_ = 0;
    size_t predict_debug_count_ = 0;
    GnssUpdateDebugRecord pending_gnss_update_debug_;
