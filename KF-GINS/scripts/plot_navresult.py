...
def plotNavresult(navresult_filepath):
    ...
    output_dir = os.path.dirname(navresult_filepath)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Horizontal_Position.png'), dpi=300)
    ...
    plt.title('Height')
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Height.png'), dpi=300)
    ...
    plt.title('Velocity')
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Velocity.png'), dpi=300)
    ...
    plt.title('Attitude')
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Attitude.png'), dpi=300)
...
def plotIMUerror(imuerr_filepath):
    ...
    output_dir = os.path.dirname(imuerr_filepath)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Gyroscope_Bias.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Accelerometer_Bias.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Gyroscope_Scale.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Accelerometer_Scale.png'), dpi=300)
...
def plotNavError(navresult_filepath, refresult_filepath):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Position_Error.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Velocity_Error.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Attitude_Error.png'), dpi=300)
...
def plotSTD(std_filepath):
    ...
    output_dir = os.path.dirname(std_filepath)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Position_STD.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Velocity_STD.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Attitude_STD.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Gyroscope_Bias_STD.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Accelerometer_Bias_STD.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Gyroscope_Scale_STD.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'Accelerometer_Scale_STD.png'), dpi=300)
...
if __name__ == '__main__':
    ...
    # 导航结果和导航误差
    navresult_filepath = os.path.join(dataset_dir, 'KF_GINS_Navresult.nav')
    refresult_filepath = os.path.join(dataset_dir, 'truth.nav')
    # 导航结果
    ...
    # 估计的IMU误差
    imuerr_filepath = os.path.join(dataset_dir, 'KF_GINS_IMU_ERR.txt')
    # plotIMUerror(imuerr_filepath)

    # 估计的导航状态标准差和IMU误差标准差
    std_filepath = os.path.join(dataset_dir, 'KF_GINS_STD.txt')
